...
/**
 */
public class CircularProgressViewSrc extends View {
	...
	public CircularProgressViewSrc(Context context) {
		super(context);
		init(null, 0);
	}

	public CircularProgressViewSrc(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}
	...
	private void initAttributes(AttributeSet attrs, int defStyle) {
		...
		if (a.hasValue(R.styleable.CircularProgressViewSrc_cpv_color)) {
			color = a.getColor(R.styleable.CircularProgressViewSrc_cpv_color,
		...
		animDuration = a.getInteger(
				R.styleable.CircularProgressViewSrc_cpv_animDuration,
				resources.getInteger(R.integer.cpv_default_anim_duration));
		animSteps = a.getInteger(
				R.styleable.CircularProgressViewSrc_cpv_animSteps,
