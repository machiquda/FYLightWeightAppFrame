package fengyu.cn.library.photopicker.fragment;
...
import fengyu.cn.library.photopicker.adapter.PhotoGridAdapter;
import fengyu.cn.library.photopicker.adapter.PopupDirectoryListAdapter;
...
import static fengyu.cn.library.photopicker.utils.MediaStoreHelper.INDEX_ALL_PHOTOS;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoGridAdapter.setOnCameraClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentMode == ImageCaptureManager.STORAGE_STRATEGY_TEMPORARY) {
                    try {
                ...
                } else if (currentMode == ImageCaptureManager.STORAGE_STRATEGY_PERPETUAL) {

                    Intent intent = captureManager.getTakePictureInent();
                    startActivityForResult(intent, ImageCaptureManager.REQUEST_TAKE_PHOTO);
                }
            }
        });
