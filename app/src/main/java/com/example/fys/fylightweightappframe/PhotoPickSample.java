...
public class PhotoPickSample extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photo_x_view.setOnPhotoClickListener(new FPhotoPickerAdapter.PhotoClickListener() {
            ...
            @Override
            public void onPhotoClick(FPhotoPickerAdapter.PhotoViewHolder holder, int position, ArrayList<String> photoPaths) {
                Toast.makeText(PhotoPickSample.this, "sdsda", Toast.LENGTH_SHORT).show();

                photoPaths.set(position,"http://p.qq181.com/cms/1206/2012062513122199124.jpg");
                photo_x_view.getPhotoAdapter().notifyItemChanged(position);
            }
